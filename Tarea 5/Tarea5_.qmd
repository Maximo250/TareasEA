...
Este documento propone una análisis de los egresos estatales reportados en la EFIPEM (2013–2023). El objetivo es explorar la estructura del gasto, comparar entre entidades y periodos, y sintetizar infromación con el fin de identificar de manera clara los puntos abordados a continuación

A continuación se explica la metodología, se preparan los datos y se presentan visualizaciones y pruebas estadísticas que ayudan a comprender la distribución del gasto estatal en México.

# Marco de clasificación del gasto

De acuerdo con la clasificación adoptada por el INEGI, el gasto estatal puede agruparse en rubros que facilitan el análisis del destino de los recursos públicos. En términos generales, pueden distinguirse partidas como:

-   Recursos para transferencias y subsidios (apoyos a terceros y organismos).
-   Gastos por servicios al personal (sueldos y prestaciones).
-   Transferencias a municipios (para programas descentralizados).
-   Inversión pública y programas sociales (obra e inversión).
-   Servicio de la deuda (amortizaciones e intereses).
-   Otros elementos: inventarios, servicios generales, adquisición de activos, disponibilidad final, provisiones financieras y rubros misceláneos.
...
El reanálisis de los egresos estatales (2013–2023) confirma que la mayor parte del gasto se concentra en rubros de carácter corriente pagos de personal, servicios y transferencias mientras que la inversión (gasto de capital) representa una fracción menor del total en la mayoría de las entidades. La exclusión de entidades de gran tamaño económico (por ejemplo, Estado de México) ayuda a visualizar mejor la heterogeneidad entre las demás entidades.
