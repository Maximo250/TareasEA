...
setwd("C:/Users/maxim/OneDrive/Documentos/data")
getwd()
...
#municipios_Baja_California <- st_read("C:/Users/maxim/OneDrive/Documentos/data/02mun.shp", options = "ENCODING=LATIN1", quiet = TRUE)
municipios_Baja_California <- st_read("C:/Users/maxim/OneDrive/Documentos/data/02mun.shp", options = "ENCODING=LATIN1", quiet = TRUE)
...
datos_total <- read_csv("C:/Users/maxim/OneDrive/Documentos/data/cpv_valor_02.csv", na = c("ND"))

datos_total <- datos_total |> filter(año == 2020)
#unique(datos_total$indicador)
datos_seleccion <- datos_total |> 
  filter(indicador %in% c("Índice de envejecimiento", "Porcentaje de mujeres" ,"Tasa de alfabetización de las personas de 15 a 24 años", "Porcentaje de hombres", "Población no católica"  ), desc_municipio != "Estatal") |> 
...
ggplot(datos) +
  geom_sf(aes(fill = porcentaje_de_hombres), color = "white", size = 0.1) +
  scale_fill_viridis_c(
    name = "Edad (mediana)"
  ) +
  labs(
...
ggplot(datos) +
  geom_histogram(aes(porcentaje_de_hombres), color="black", fill = "olivedrab", boundary=min(datos$porcentaje_de_hombres), binwidth = 2) +
  labs(
    title = "Distribución de la Edad",
...
ggplot(datos) +
  geom_density(aes(porcentaje_de_hombres), color="black", fill = "firebrick", alpha=0.6) +
  labs(
    title = "Distribución de la Edad",
    x = "Edad (años)", y = "Densidad"
  ) +
...
ggplot(data = datos, aes(x = "", y = porcentaje_de_hombres)) +
    geom_boxplot(
    fill = "#4A90E2",           # Color de relleno
    color = "#2C5F7A",          # Color del borde más oscuro
    alpha = 0.8,                # Transparencia
...
# Q-Q Plot básico para normalidad
ggplot(data = datos, aes(sample = porcentaje_de_hombres)) +
    stat_qq(color = "#4A90E2", size = 2, alpha = 0.7) +
    stat_qq_line(color = "#E74C3C", linewidth = 1, linetype = "dashed") +
    scale_x_continuous(name = "Cuantiles Teóricos (Distribución Normal)",
    breaks = pretty_breaks(n = 6)) +
...
ggplot(data = datos, aes(x = porcentaje_de_hombres, y = reorder(NOMGEO, porcentaje_de_hombres))) +
  geom_point(color = "#4A90E2", size = 3, alpha = 0.8) +
  geom_segment(aes(x = 0, xend = porcentaje_de_hombres, y = NOMGEO, yend = NOMGEO),
    color = "#BDC3C7", size = 0.5, alpha = 0.7) +
  scale_x_continuous(
    name = "Edad (años)",
    breaks = pretty_breaks(n = 6),
...
ggplot(datos) +
  geom_sf(aes(fill = porcentaje_de_mujeres), color = "white", size = 0.1) +
  scale_fill_viridis_c(
    name = "Porcentaje de mujeres"
  ) +
  labs(
    title = "Porcentaje de mujeres en el estado de Baja California",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(datos) +
  geom_histogram(aes(porcentaje_de_mujeres), color="black", fill = "olivedrab", boundary=min(datos$porcentaje_de_mujeres), binwidth = 2) +
  labs(
    title = "Distribución de la Edad",
    x = "Edad (años)", y = "Frecuencia"
  ) +
...
ggplot(datos) +
  geom_density(aes(porcentaje_de_mujeres), color="black", fill = "firebrick", alpha=0.6) +
  labs(
    title = "Distribución de la Edad",
    x = "Edad (años)", y = "Densidad"
  ) +
...
ggplot(data = datos, aes(x = "", y = porcentaje_de_mujeres)) +
    geom_boxplot(
    fill = "#4A90E2",           # Color de relleno
    color = "#2C5F7A",          # Color del borde más oscuro
    alpha = 0.8,                # Transparencia
  ...
  geom_jitter(alpha = 0.3, color = "#34495E", size = 1.5, width = 0.1) +
  scale_y_continuous(breaks = pretty_breaks(n = 8), labels = function(x) paste(x, "años")) +
  labs(title = "Distribución de porcentaje de mujeres", 
  subtitle = "Población del Estado de Baja California",
  y = "Edad (años)",
  x = "")+
  theme_bw()+
...
# Q-Q Plot básico para normalidad
ggplot(data = datos, aes(sample = porcentaje_de_mujeres)) +
    stat_qq(color = "#4A90E2", size = 2, alpha = 0.7) +
    stat_qq_line(color = "#E74C3C", linewidth = 1, linetype = "dashed") +
    scale_x_continuous(name = "Cuantiles Teóricos (Distribución Normal)",
    breaks = pretty_breaks(n = 6)) +
    ...
    labels = function(x) paste(x, "años")) +
    labs(title = "Gráfico Q-Q para Normalidad",
    subtitle = "Edad Mediana - Porcentaje de mujeres") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(data = datos, aes(x = porcentaje_de_mujeres, y = reorder(NOMGEO, tasa_de_alfabetizacion_de_las_personas_de_15_a_24_anos))) +
  geom_point(color = "#4A90E2", size = 3, alpha = 0.8) +
  geom_segment(aes(x = 0, xend = tasa_de_alfabetizacion_de_las_personas_de_15_a_24_anos, y = NOMGEO, yend = NOMGEO),
    color = "#BDC3C7", size = 0.5, alpha = 0.7) +
  scale_x_continuous(
  ...
  labs(
    title = "Dot Plot - Porcentaje de mujeres",
    subtitle = "Estado de Baja California") +
  theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
...
ggplot(datos) +
  ...
  labs(
    title = "-Indice de envejecimiento del estado de Baja California ",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(x = "", y =  indice_de_envejecimiento)) +
  ...
  geom_jitter(alpha = 0.3, color = "#34495E", size = 1.5, width = 0.1) +
  scale_y_continuous(breaks = pretty_breaks(n = 8), labels = function(x) paste(x, "años")) +
  labs(title = "Distribución del indice de envejecimiento", 
  subtitle = "Población del Estado de Baja California",
  y = "Edad (años)",
  x = "")+
  theme_bw()+
